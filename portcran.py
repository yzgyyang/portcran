...
def update_category(portsdir: LocalPath, category: str, name: str) -> None:
    entry = "    SUBDIR += %s\n" % name
    ...
    def create(args: Namespace) -> None:
        ...
        for category in categories:
            if category not in Ports.categories:
                ...
                exit(ERR_CATEGORY)
        portsdir = Ports.dir if args.portsdir is None else LocalPath(args.portsdir)
